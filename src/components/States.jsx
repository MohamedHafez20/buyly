...
export function ProductCardSkeleton() {
  return (
    <div className="flex animate-pulse flex-col">
      <div className="aspect-[3/4.35] w-full rounded-[6px] bg-neutral-100" />
      <div className="space-y-2 pt-3.5">
        ...
        <div className="h-3 w-18 bg-neutral-100" />
      </div>
    </div>
  )
}
...
export function ProductGridSkeleton({ count = 8 }) {
  return (
    <div className="grid grid-cols-2 gap-x-4 gap-y-11 sm:gap-x-6 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-7">
